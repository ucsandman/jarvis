...
const allowed = new Set(['index.html','site.css','site.js','vercel.json','mark.svg','reference.svg','workbench.png','revision.png','streaming.png','og.png','robots.txt','sitemap.xml','llms.txt','.vercel','.env.local','.gitignore']);
...
for (const [source,target] of [['public/mark.svg','mark.svg'],['public/reference.svg','reference.svg'],['docs/images/workbench.png','workbench.png'],['docs/images/revision.png','revision.png'],['docs/images/streaming.png','streaming.png'],['docs/images/social.png','og.png']]) await copyFile(source,join(out,target));
