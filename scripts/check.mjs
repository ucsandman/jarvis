...
for (const asset of ['app.js','style.css','mark.svg','reference.svg','demo.html']) await readFile(`public/${asset}`);
if (!html.includes('name="robots" content="noindex,nofollow"')) throw new Error('Missing local-app noindex.');
console.log(`PASS: syntax checked ${files.length} JavaScript files; 5 assets present; local page is noindex. No compilation required.`);
