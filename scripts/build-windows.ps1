...
$jarvisIcon = Join-Path $jarvisRoot 'desktop/sidelook.ico'
if (-not (Test-Path -LiteralPath $jarvisIcon)) { throw 'desktop/sidelook.ico is missing. Run scripts/build-icon.ps1 first.' }
