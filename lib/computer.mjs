...
export class Computer {
  ...
  async observe(action){
    if(action.kind==='launch')return {available:false,summary:'A new window may have opened. Refresh the list and choose it yourself; Sidelook does not inspect it on its own.'};
