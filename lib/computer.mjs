...
export class WindowsComputer {
  ...
  start(){
    ...
    const child=spawn('powershell.exe',['-NoProfile','-STA','-File',fileURLToPath(new URL('../scripts/computer.ps1',import.meta.url))],{windowsHide:true,env:subscriptionEnv(),stdio:['pipe','pipe','pipe']});
