...
- Sidelook may use only models from the catalog in `public/models.js` (OpenAI models through Codex, Anthropic models through Claude Code), through existing **OpenAI or Anthropic monthly subscriptions**.
