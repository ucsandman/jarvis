...
internal static class Launcher {
    ...
    static int Main(string[] args) {
        ...
        try {
            var loading = new Form { Text="Starting Jarvis", Icon=SidelookMark.AppIcon(), Width=440, Height=180, StartPosition=FormStartPosition.CenterScreen, FormBorderStyle=FormBorderStyle.FixedDialog, MaximizeBox=false, MinimizeBox=false, ControlBox=false };
            ...
            loading.Shown += async delegate {
                try {
                    ...
                    Tray=new NotifyIcon { Icon=SidelookMark.AppIcon(), Text="Jarvis", ContextMenuStrip=menu, Visible=true };
